...
Without this, a backgrounded tab keeps hammering the portfolio book
endpoints (/api/portfolio, equity-curve, closed, holdings — every 60s)
for the entire trading day, and multiple stale tabs multiply load
against the Schwab-backed server. The visibilitychange listener also
triggers an immediate refresh on return so the UI doesn't carry stale
data forward.
