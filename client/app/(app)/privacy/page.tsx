        ...
        <article className="lg-card prose-terms min-w-0 p-6 sm:p-8">
          ...
          <Section id="how-we-use-it" num={3} title="How We Use It">
            ...
            <ul>
              ...
              <li>Sending you the daily picks email at 9:30 AM ET, the EOD summary at 4:00 PM ET, the Friday weekly digest, and occasional one-shot announcements about feature changes.</li>
