      ...
      <div className="grid gap-10 lg:grid-cols-[200px_1fr]">
        ...
        <article className="prose-terms min-w-0">
          <Section id="experimental" num={1} title="Experimental Nature of This Service">
            ...
            <p>
              All trade ideas presented on this platform are machine-generated suggestions, not recommendations. They are produced by two large language models running independently, OpenAI GPT-5.4
              and Anthropic Claude Opus 4.6, each analyzing publicly available sentiment data and live market information through the same automated workflow. These outputs have not been reviewed,
              verified, or endorsed by any licensed financial professional.
            </p>
          </Section>
          ...
          <Section id="data" num={5} title="Data Sources & Accuracy">
            <p>
              Trade suggestions are generated using data from third-party sources including Reddit (r/wallstreetbets, r/options), the OpenAI and Anthropic language model APIs, and the Schwab Market
              Data API. While we strive for accuracy, we make no guarantees regarding the completeness, reliability, or timeliness of any data presented.
            </p>
