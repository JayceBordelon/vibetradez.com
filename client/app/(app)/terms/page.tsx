        ...
        <article className="prose-terms min-w-0">
          <Section id="experimental" num={1} title="Experimental Nature of This Service">
            ...
            <p>
              ...
              Opus 4.6, running independently with the same prompt and the same toolset over publicly available sentiment data and live market information. After both models produce their picks, each
