...
export function PageToolbar({ title, subtitle, primaryControls, secondaryControls, rightSlot }: PageToolbarProps): React.JSX.Element {
  const hasControls = Boolean(primaryControls || secondaryControls || rightSlot);

  return (
    <div className={cn("sticky top-0 z-10 border-b bg-background/80 backdrop-blur-md")}>
