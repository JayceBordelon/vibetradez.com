        ...
        <AccordionItem value="pipeline">
          ...
          <AccordionContent>
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-muted-foreground">
              ...
              score is the average. When only one model picked a ticker the other side&apos;s score is left at zero. Final rank is by combined score with consensus picks tie-breaking ahead of
              single-model picks. The All / OpenAI / Claude filter in the nav bar lets you slice the day either as the merged consensus view or as exactly what one model would have produced on its
              own.
            </p>
            <p className="mt-3 text-[15px] leading-relaxed text-muted-foreground">
              All positions are opened at the market open and closed at 4:05 PM ET. No trades are held overnight. The model identifiers used in production are configurable via the OPENAI_MODEL and
              ANTHROPIC_MODEL environment variables and default to the latest production model in each provider&apos;s official Go SDK.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="metrics">
          ...
          <AccordionContent>
            <ul className="space-y-2 text-[15px] leading-relaxed text-muted-foreground">
              <li>
                <strong className="text-foreground">Profit Factor:</strong> ratio of gross winning P&amp;L to gross losing P&amp;L. A value above 1.0 means the system is net profitable.
              </li>
              <li>
                <strong className="text-foreground">Expectancy:</strong> average dollar P&amp;L per trade, accounting for both win rate and average win/loss size. Positive expectancy implies long-run
                profitability.
              </li>
              <li>
                <strong className="text-foreground">Sharpe Ratio:</strong> risk-adjusted return calculated as the mean daily P&amp;L divided by its standard deviation. Higher values indicate more
                consistent returns.
              </li>
              <li>
                <strong className="text-foreground">Max Drawdown:</strong> largest peak-to-trough decline in cumulative P&amp;L. Reflects the worst observed losing streak.
              </li>
              <li>
                <strong className="text-foreground">Return on Capital (ROC):</strong> net P&amp;L divided by total capital deployed. Measures how efficiently invested capital generates returns.
              </li>
            </ul>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="pricing">
          ...
          <AccordionContent>
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              ...
              P&amp;L figures assume single-contract positions (100 shares notional) and do not include commissions or slippage.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="sources">
          ...
          <AccordionContent>
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              ...
              Reddit&apos;s public JSON feeds. Both LLMs can additionally use a built-in web search tool to verify catalysts, earnings dates, and recent news. Every price you see in a pick comes from
              real market data, and the models are explicitly instructed never to guess prices.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="comparison">
          ...
          <AccordionContent>
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              ...
              realised P&amp;L from the EOD summaries, and aggregate by model. The line chart shows the cumulative P&amp;L you would have made by following only OpenAI, only Claude, or the combined
              consensus ranking. The agreement-rate stat shows the fraction of dual-scored trades where the two models were within one point of each other, which serves as a rough gauge of how much
              the models actually disagree on what looks like a good setup.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="disclaimers">
          ...
          <AccordionContent>
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              ...
              constitute financial advice. Options trading involves substantial risk and is not suitable for all investors. Always do your own research before making investment decisions.
            </p>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
