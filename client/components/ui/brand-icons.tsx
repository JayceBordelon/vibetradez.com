...
export function OpenAILogo({ className, fill, ...props }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill={fill ?? OPENAI_COLOR} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" className={className} {...props}>
      <title>OpenAI</title>
...
/**
 * Official Claude product mark, sourced from Anthropic's marketing SVG.
 * Renders in Claude orange (#D97757) by default. Pass an explicit `fill`
 * prop to override (e.g. for printing on a colored background).
 */
export function ClaudeLogo({ className, fill, ...props }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" className={className} {...props}>
      <title>Claude</title>
      <path
