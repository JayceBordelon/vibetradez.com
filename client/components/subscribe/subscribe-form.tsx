  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div>
        ...
        <Input id="sub-name" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} autoComplete="name" />
      </div>
      <div>
        <Label htmlFor="sub-email" className="text-[11px] uppercase tracking-wide">
          Email
        </Label>
        <Input id="sub-email" type="email" placeholder="you@example.com" required value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" />
      </div>
